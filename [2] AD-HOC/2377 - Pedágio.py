...
comp_estrada = int(entrada_1[0])
dist_pedagios = int(entrada_1[1])
entrada_2 = str(input()).split()
custo_km = int(entrada_2[0])
valor_pedagio = int(entrada_2[1])
custo = comp_estrada * custo_km
num_pedagio  = comp_estrada // dist_pedagios
custo += num_pedagio * valor_pedagio
print(custo)